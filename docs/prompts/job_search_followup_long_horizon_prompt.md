You are hardening and extending the Job Search CLI Tool (`job_search_tool`). Start by reading documents:
- [docs/job_search_tool_followup_prompts.md](../job_search_tool_followup_prompts.md)
...
1. If a branch named `feature/job-search-followup` does not exist, create it from main and check it out.
2. After completing each numbered step in the prompt plan (Prompt 11, Prompt 12, Prompt 13, etc.), stage all new and modified files, commit, and push.
...
- Prompts 1–10 are already complete and working
